...
var azureSqlConnection = Configuration.GetConnectionString("AzureSQL")
    .Replace("__AZURE_SQL_PASSWORD__", Environment.GetEnvironmentVariable("AZURE_SQL_PASSWORD"));

var storageAccount = Configuration.GetConnectionString("StorageAccount")
    .Replace("__AZURE_STORAGE_ACCOUNT_KEY__", Environment.GetEnvironmentVariable("AZURE_STORAGE_ACCOUNT_KEY"));

var blobArchive = Configuration.GetConnectionString("BlobArchive")
    .Replace("__AZURE_STORAGE_ACCOUNT_ARCHIVE_KEY__", Environment.GetEnvironmentVariable("AZURE_STORAGE_ACCOUNT_ARCHIVE_KEY"));
